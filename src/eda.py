...
def create_userActivity_graph(df, target, out_folder, base_outdir):
    '''
...
def createToxicityBoxPlots(df, attribute_type, indiv, base_outidr):
    '''
...
def calculate_stats(data_dict, test=False):
    ...
    for indiv in artist_names:
        ...
        plt.clf()
        create_userActivity_graph(userActivity_df, indiv, out_folder, base_outdir)
        plt.clf()
